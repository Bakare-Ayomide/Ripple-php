...
define('REMOTE_DIR', '/home/zerolord/public_html/ripple.zerolord.com/posts');
...
function saveUploadToFtp($filename) {
    ...
    // Upload location 1
    $path1 = '/home/zerolord/public_html/ripple.zerolord.com/posts/uploads';
    @ftp_mkdir($conn, $path1);
    @ftp_put($conn, $path1 . '/' . $filename, $localFile, FTP_BINARY);

    // Upload location 2
    $path2 = '/home/zerolord/public_html/ripple.zerolord.com/uploads';
...
function downloadUploadFromFtp($filename) {
    ...
    $path = '/home/zerolord/public_html/ripple.zerolord.com/uploads/' . $filename;
