...
export const useUpdatePost = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (is_time_capsule !== undefined) updateData.is_time_capsule = is_time_capsule;
      if (unlocks_at !== undefined) updateData.unlocks_at = unlocks_at;
      if (is_recurring !== undefined) updateData.is_recurring = is_recurring;
      if (recurrence_interval !== undefined) updateData.recurrence_interval = recurrence_interval;
      if (status !== undefined) updateData.status = status;
      if (is_published !== undefined) updateData.is_published = is_published;
      if (is_moderated !== undefined) updateData.is_moderated = is_moderated;
